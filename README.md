# MODEL1310110013: MODEL1310110013
...
`pip install git+https://github.com/biomodels/MODEL1310110013.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110013.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110013 as model`
...
The model of pancreas islets of Langerhans metabolism is derived from the
...
and identified by:
[MODEL1310110013](http://identifiers.org/biomodels.db/MODEL1310110013) .
